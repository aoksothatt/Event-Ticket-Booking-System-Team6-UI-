...
const languages = [
  { code: "en", label: "En", badge: "English" },
  { code: "km", label: "ខ្មែរ", badge: "ភាសាខ្មែរ" },
];
  ...
  <div ref="rootEl" class="relative">
    ...
    >
      <div
        v-if="open"
        role="listbox"
        class="absolute right-0 top-full z-50 mt-1 w-fit overflow-hidden rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#162438] py-1.5 shadow-2xl shadow-black/20 dark:shadow-black/40"
      >
        <button
