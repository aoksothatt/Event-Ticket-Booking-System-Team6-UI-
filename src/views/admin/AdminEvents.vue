    ...
    >
      <div>
        <div class="flex items-center gap-2.5">
          ...
          <span
            class="rounded-md bg-amber-100 border border-amber-200 px-2.5 py-0.5 text-xs text-amber-800 font-mono font-medium dark:bg-amber-500/15 dark:border-amber-500/30 dark:text-amber-400"
          >
            manage_events
          </span>
        </div>
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  ...
                  <div class="min-w-0">
                    ...
                    >
                      <span
                        class="rounded bg-slate-100 border border-slate-200 px-1.5 py-0.5 text-[10px] font-semibold text-amber-700 dark:bg-slate-700 dark:border-slate-600 dark:text-amber-400"
                        >{{ event.category?.name || t("na") }}</span
                      >
                      <span class="truncate"
                        >{{ t("by") }}
                        {{ event.organizer?.company_name || t("na") }}</span
                      >
                    </div>
                  </div>
                </div>
